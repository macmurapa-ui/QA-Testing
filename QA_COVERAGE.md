...
1. **Dashboard access via impersonation (8.1)** — prerequisite for all Dashboard tests
2. **Move-out wizard Dashboard (8.5)** — agent-led submission; primary revenue driver
3. **Move-in wizard Dashboard (8.6)** — void closure

### Sprint 3 — Reporting + Data Integrity

1. **Conversions report (7.1)** — validate OVO outcome codes (SALI, DONS, FDFD)
2. **CWN status (7.5)** — council notification compliance
3. **Erroneous transfer check (7.6)** — regulatory red line

### Sprint 4 — Partner API Coverage

1. **POST branch / landlord / property / move (9.1, 9.4, 9.8, 9.13, 9.14)** — core create flow via API
2. **GET / PATCH / DELETE (9.2, 9.3, 9.5-9.7, 9.9-9.12, 9.15-9.18)** — full 18-endpoint sweep

### Sprint 5 — Billing Preferences

1. **Billing preference V2 (10.2)** — when V2 development ships; 61 scenario matrix ready
