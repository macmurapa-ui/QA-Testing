...
(async () => {
  console.log('═══════════════════════════════════════════════════════');
  console.log(' HTM Clone - Test Run 015: Branch Creation');
  console.log('═══════════════════════════════════════════════════════');
  ...
  await page.screenshot({ path: `${SS_DIR}/015_branch_form.png`, fullPage: true });
  ...
  await page.screenshot({ path: `${SS_DIR}/015_branch_form_filled.png`, fullPage: true });
  ...
  if (postCreateUrl.includes('/branches/new')) {
    await page.screenshot({ path: `${SS_DIR}/015_branch_error.png`, fullPage: true });
    console.log('ERROR: Branch creation failed. Check 015_branch_error.png');
    await browser.close(); process.exitCode = 1; return;
  }
  ...
  await page.screenshot({ path: `${SS_DIR}/015_branch_search.png`, fullPage: true });
  ...
  await page.waitForTimeout(800);
  await page.screenshot({ path: `${SS_DIR}/015_branch_page.png`, fullPage: true });
